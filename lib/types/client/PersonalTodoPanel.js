...
/** 打开待办面板并提示待处理事项的侧栏入口。 */
export function PersonalTodoTrigger({ wide, t, list, dataCenter, canvas, openCanvas }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: CSS }), _jsx("div", { className: "dsh-personal-todo-trigger-row", "data-wide": wide, children: _jsxs("button", { type: "button", className: "dsh-personal-todo-trigger", "aria-label": triggerLabel, title: triggerLabel, "data-wide": wide, onClick: openCanvas, children: [_jsx(ListTodo, { size: wide ? 16 : 18, "aria-hidden": "true" }), wide ? _jsx("span", { className: "dsh-personal-todo-trigger-label", children: t('trigger.label') }) : null, snapshot.attentionCount > 0 && (_jsx("span", { className: "dsh-personal-todo-attention", "aria-hidden": "true", children: snapshot.attentionCount }))] }) })] }));
}
