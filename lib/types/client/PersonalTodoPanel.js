...
export function PersonalTodoPanel(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: CSS }), _jsx(Button, { className: "dsh-personal-todo-trigger", variant: "ghost", size: "sm", icon: _jsx(IconListPenOutline16, {}), "aria-label": t('trigger.aria'), title: t('trigger.aria'), "data-wide": wide, onClick: () => { setOpen(true); }, children: wide ? t('trigger.label') : null }), _jsxs(Modal, { open: open, onClose: close, title: t('panel.title'), closeLabel: t('panel.close'), description: t('panel.description'), className: "dsh-personal-todo-dialog", contentClassName: "dsh-personal-todo-body", children: [_jsxs("div", { className: "dsh-personal-todo-toolbar", children: [_jsxs("div", { className: "dsh-personal-todo-tabs", children: [_jsx("button", { type: "button", className: "dsh-personal-todo-tab", "data-active": view === 'active', onClick: () => { setView('active'); setSelectedId(undefined); setDetail(undefined); }, children: t('tab.active') }), _jsx("button", { type: "button", className: "dsh-personal-todo-tab", "data-active": view === 'completed', onClick: () => { setView('completed'); setSelectedId(undefined); setDetail(undefined); }, children: t('tab.completed') })] }), _jsx(Button, { size: "sm", variant: "primary", icon: _jsx(IconPlusOutline16, {}), onClick: () => { setForm({ ...EMPTY_FORM }); }, children: t('action.add') }), _jsx(Button, { size: "sm", icon: _jsx(IconRefreshOutline16, {}), disabled: busy, onClick: () => { void refresh(); }, children: t('action.refresh') }), _jsx("span", { className: "dsh-personal-todo-count", children: summary })] }), _jsxs("form", { className: "dsh-personal-todo-filters", onSubmit: (event) => {
                            event.preventDefault();
                            setFilters({ search: searchDraft.trim(), tags: tagsFromText(tagsDraft) });
                        }, children: [_jsx(Input, { value: searchDraft, onChange: event => { setSearchDraft(event.target.value); }, placeholder: t('search.placeholder'), "aria-label": t('search.aria') }), _jsx(Input, { value: tagsDraft, onChange: event => { setTagsDraft(event.target.value); }, placeholder: t('tags.placeholder'), "aria-label": t('tags.aria') }), _jsx(Button, { size: "sm", variant: "outline", type: "submit", children: t('action.apply') })] }), error !== undefined && _jsx("div", { className: "dsh-personal-todo-error", role: "alert", children: t('state.error', { message: error }) }), _jsxs("div", { className: "dsh-personal-todo-workspace", children: [_jsxs("div", { className: "dsh-personal-todo-list", children: [busy && todos.length === 0 && _jsx("div", { className: "dsh-personal-todo-empty", children: t('state.loading') }), !busy && visibleTodos.length === 0 && _jsx("div", { className: "dsh-personal-todo-empty", children: emptyMessage }), visibleTodos.map(todo => (_jsxs("article", { className: "dsh-personal-todo-item", "data-selected": todo.id === selectedId, children: [_jsxs("button", { type: "button", className: "dsh-personal-todo-select", onClick: () => { selectTodo(todo.id); }, children: [_jsx("h3", { children: todo.title }), todo.latestSummary !== null && _jsx("p", { children: todo.latestSummary }), _jsxs("div", { className: "dsh-personal-todo-meta", children: [_jsx("span", { className: "dsh-personal-todo-badge", "data-status": todo.status, children: statusLabel(todo.status) }), _jsx("span", { className: "dsh-personal-todo-badge", "data-priority": todo.priority, children: priorityLabel(todo.priority) }), todo.tags.map(tag => _jsxs("span", { className: "dsh-personal-todo-badge", children: ["#", tag] }, tag))] })] }), _jsxs("div", { className: "dsh-personal-todo-actions", children: [todo.status === 'pending' && _jsx(Button, { size: "sm", variant: "primary", disabled: busy, onClick: () => { void mutate(signal => start(todo.id, signal)); }, children: t('action.start') }), _jsx(Button, { size: "sm", icon: _jsx(IconEditOutline16, {}), disabled: busy, "aria-label": t('action.edit'), onClick: () => { setForm(formOf(todo)); } })] })] }, todo.id))), result?.hasMore === true && _jsx(Button, { className: "dsh-personal-todo-more", size: "sm", variant: "outline", disabled: busy, onClick: () => { void fetchPage(todos.length, true); }, children: t('action.loadMore') })] }), _jsxs("section", { className: "dsh-personal-todo-detail", children: [selectedId === undefined && _jsx("div", { className: "dsh-personal-todo-empty", children: t('detail.empty') }), selectedId !== undefined && detail === undefined && _jsx("div", { className: "dsh-personal-todo-empty", children: t('state.loadingDetail') }), detail !== undefined && detail.todo.id === selectedId && _jsxs(_Fragment, { children: [_jsxs("div", { className: "dsh-personal-todo-detail-header", children: [_jsxs("div", { children: [_jsx("h2", { children: detail.todo.title }), _jsxs("div", { className: "dsh-personal-todo-meta", children: [_jsx("span", { className: "dsh-personal-todo-badge", "data-status": detail.todo.status, children: statusLabel(detail.todo.status) }), _jsx("span", { children: t('meta.reviewRound', { round: detail.todo.reviewRound }) })] })] }), _jsxs("div", { className: "dsh-personal-todo-detail-actions", children: [detail.todo.status === 'pending' && _jsx(Button, { variant: "primary", disabled: busy, onClick: () => { void mutate(signal => start(detail.todo.id, signal)); }, children: t('action.start') }), detail.todo.primarySessionId !== null && _jsx(Button, { variant: "outline", onClick: () => { openConversation(detail.todo.primarySessionId); }, children: t('action.openConversation') }), (detail.todo.status === 'pending' || detail.todo.status === 'completed' || detail.todo.status === 'cancelled') && _jsx(Button, { variant: "outline", icon: _jsx(IconTrashOutline16, {}), onClick: () => { setConfirming(detail.todo); }, children: t('action.delete') })] })] }), detail.todo.notes !== null && _jsx("p", { children: detail.todo.notes }), detail.todo.blockedReason !== null && _jsxs("div", { className: "dsh-personal-todo-callout", children: [_jsx("strong", { children: t('detail.waitingForYou') }), _jsx("p", { children: detail.todo.blockedReason }), _jsxs("div", { className: "dsh-personal-todo-feedback", children: [_jsx("textarea", { "aria-label": t('reply.aria'), value: replyText, onChange: event => { setReplyText(event.target.value); }, placeholder: t('reply.placeholder') }), _jsx(Button, { variant: "primary", disabled: busy || replyText.trim() === '', onClick: () => { void mutate(signal => reply({ id: detail.todo.id, message: replyText }, signal)).then(saved => { if (saved)
                                                                    setReplyText(''); }); }, children: t('action.reply') })] })] }), detail.todo.status === 'in_review' && selectedRun !== undefined && _jsxs("div", { className: "dsh-personal-todo-review", children: [_jsx("strong", { children: t('detail.review') }), _jsxs("dl", { children: [_jsx("dt", { children: t('review.summary') }), _jsx("dd", { children: selectedRun.resultSummary ?? '—' }), _jsx("dt", { children: t('review.verification') }), _jsx("dd", { children: selectedRun.verification ?? '—' }), _jsx("dt", { children: t('review.risk') }), _jsx("dd", { children: selectedRun.risk ?? '—' })] }), _jsx("div", { className: "dsh-personal-todo-detail-actions", children: _jsx(Button, { variant: "primary", disabled: busy, onClick: () => { void mutate(signal => approve(detail.todo.id, signal)); }, children: t('action.approve') }) }), _jsxs("div", { className: "dsh-personal-todo-feedback", children: [_jsx("textarea", { "aria-label": t('feedback.aria'), value: feedback, onChange: event => { setFeedback(event.target.value); }, placeholder: t('feedback.placeholder') }), _jsx(Button, { variant: "outline", disabled: busy || feedback.trim() === '', onClick: () => { void mutate(signal => requestChanges({ id: detail.todo.id, feedback }, signal)).then(saved => { if (saved)
                                                                    setFeedback(''); }); }, children: t('action.requestChanges') })] })] }), _jsx("h3", { children: t('detail.conversations') }), detail.sessions.length === 0 ? _jsx("p", { children: t('detail.noConversations') }) : detail.sessions.map(session => _jsxs("div", { className: "dsh-personal-todo-session", children: [_jsx("span", { children: t('session.primary') }), _jsx(Button, { size: "sm", variant: "outline", onClick: () => { openConversation(session.sessionId); }, children: t('action.openConversation') })] }, session.sessionId)), _jsx("h3", { children: t('detail.activity') }), _jsx("div", { className: "dsh-personal-todo-timeline", children: detail.events.map(event => _jsxs("div", { className: "dsh-personal-todo-event", children: [_jsx("span", { children: "\u2022" }), _jsxs("span", { children: [_jsx("strong", { children: eventLabel(event.type) }), event.message === null ? null : _jsxs(_Fragment, { children: [" \u00B7 ", event.message] })] }), _jsx("time", { children: new Date(event.createdAt).toLocaleString() })] }, event.id)) })] })] })] })] }), _jsx(Modal, { open: form !== undefined, onClose: () => { setForm(undefined); }, title: formTitle, closeLabel: t('action.cancel'), className: "dsh-personal-todo-small-dialog", children: form !== undefined && _jsxs("div", { className: "dsh-personal-todo-form", children: [_jsxs("label", { className: "dsh-personal-todo-field", "data-wide": "true", children: [t('field.title'), _jsx(Input, { autoFocus: true, value: form.title, maxLength: 200, placeholder: t('field.titlePlaceholder'), onChange: event => { setForm({ ...form, title: event.target.value }); } })] }), _jsxs("label", { className: "dsh-personal-todo-field", "data-wide": "true", children: [t('field.notes'), _jsx("textarea", { value: form.notes, maxLength: 10_000, placeholder: t('field.notesPlaceholder'), onChange: event => { setForm({ ...form, notes: event.target.value }); } })] }), _jsxs("label", { className: "dsh-personal-todo-field", children: [t('field.priority'), _jsxs("select", { value: form.priority, onChange: event => { setForm({ ...form, priority: event.target.value }); }, children: [_jsx("option", { value: "none", children: t('priority.none') }), _jsx("option", { value: "low", children: t('priority.low') }), _jsx("option", { value: "medium", children: t('priority.medium') }), _jsx("option", { value: "high", children: t('priority.high') })] })] }), _jsxs("label", { className: "dsh-personal-todo-field", children: [t('field.dueAt'), _jsx(Input, { type: "datetime-local", value: form.dueLocal, onChange: event => { setForm({ ...form, dueLocal: event.target.value }); } })] }), _jsxs("label", { className: "dsh-personal-todo-field", "data-wide": "true", children: [t('field.tags'), _jsx(Input, { value: form.tags, placeholder: t('field.tagsPlaceholder'), onChange: event => { setForm({ ...form, tags: event.target.value }); } })] }), _jsxs("div", { className: "dsh-personal-todo-form-actions", children: [_jsx(Button, { variant: "outline", onClick: () => { setForm(undefined); }, children: t('action.cancel') }), _jsx(Button, { variant: "primary", disabled: busy || form.title.trim() === '', onClick: saveForm, children: form.id === undefined ? t('action.create') : t('action.save') })] })] }) }), _jsx(Modal, { open: confirming !== undefined, onClose: () => { setConfirming(undefined); }, title: t('delete.title'), closeLabel: t('delete.close'), description: confirming === undefined ? '' : t('delete.description', { title: confirming.title }), className: "dsh-personal-todo-small-dialog", footer: _jsxs(_Fragment, { children: [_jsx(Button, { variant: "outline", onClick: () => { setConfirming(undefined); }, children: t('action.cancel') }), _jsx(Button, { variant: "primary", disabled: busy, onClick: () => {
