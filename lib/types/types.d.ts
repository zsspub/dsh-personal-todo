...
export type LiveTodo = Omit<Todo, 'executionStatus'> & {
    readonly executionStatus: TodoLiveStatus | null;
};
export type LiveTodoDetail = Omit<TodoDetail, 'todo'> & {
    readonly todo: LiveTodo;
};
export type LiveTodoListResult = Omit<TodoListResult, 'todos'> & {
    readonly todos: LiveTodo[];
};
