...
const PERSONAL_TODO_SCHEMA_VERSION = 2;
...
var TodoStore = class {
	...
	initialize() {
		...
		if (row.user_version > 2) throw new PersonalTodoError(`personal todo database schema ${String(row.user_version)} is newer than supported version ${String(2)}`);
