...
export function normalizePresentationQuery(input) {
...
export function personalTodoPresentationMeta(input, result) {
...
export function isPersonalTodoPresentationMeta(value) {
